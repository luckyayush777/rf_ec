...
- On a small screen, tap **Focus GPU** to hide the workbench and zoom in on the card. Tap **Inspect GPU** to rotate it for rear screws. After lifting a fan or cooler, tap **Store part** to set it aside without finding room on the desk; **Refit fan/cooler** brings it back. With the screwdriver equipped, hold **Refit screw** to reinstall a stored screw. **Exit focus** returns to the desk.
